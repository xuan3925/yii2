        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <div class="form-group field-admin-adminuser">
                    ...
                    <?php echo $form->field($model,'adminUser')->textInput(['class'=>'span12','placeholder'=>'管理员账号'])?></div>
                <div class="form-group field-admin-adminemail">
                    <p class="help-block help-block-error"></p>
                    <?php echo $form->field($model,'adminMail')->textInput(['class'=>'span12','placeholder'=>'管理员邮箱'])?></div>
                <a href="<?php echo yii\helpers\Url::to(['public/login']);?>" class="forgot">返回登录</a>
<!--                <button type="submit" class="btn-glow primary login">找回密码</button>-->
